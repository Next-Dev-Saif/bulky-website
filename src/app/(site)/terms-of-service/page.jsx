...
const sections = [
  {
    ...
    icon: UserCheck,
    content:
      "By accessing Bulky, you agree to be bound by these Terms. If you do not agree, you must not use our services.",
  },
  {
    title: "Service Description",
    icon: FileText,
    content:
      "Bulky connects users with transport services for bulky items. We act as a facilitator and strive to maintain high service standards.",
  },
  {
    title: "User Responsibilities",
    icon: AlertCircle,
    content:
      "You must provide accurate item information. Misrepresentation of weight or dimensions may result in additional charges or cancellation.",
  },
  {
    title: "Governing Law",
    icon: Scale,
    content:
      "These terms are governed by the laws of the jurisdiction where Bulky operates. You agree to the exclusive jurisdiction of courts in that region.",
  },
];
      ...
      <div className="container-custom">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-8">
          <p className="text-sm text-text-light font-medium leading-relaxed">
            Please read these terms carefully before using Bulky. These Terms
            govern your access to and use of our transport facilitation
            services.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-5">
          <p className="text-xs text-text-light/60 font-medium leading-relaxed">
            <strong className="text-secondary">DISCLAIMER:</strong> THE SERVICES
            ARE PROVIDED &quot;AS IS&quot; WITHOUT WARRANTIES OF ANY KIND,
            EXPRESS OR IMPLIED. BULKY DISCLAIMS ALL REPRESENTATIONS AND
