...
const faqs = [
  {
    ...
    a: "Once confirmed, track your booking in real-time from your Dashboard under 'My Bookings'. You'll also receive notifications for every status update.",
  },
  {
    q: "What items can I transport?",
    a: "Bulky supports large items — furniture, appliances, construction materials, motorcycles, and more. See the full list when creating a booking.",
  },
  {
    q: "How do I cancel a booking?",
    a: "From the Booking Detail page. Note: cancellations less than 1 hour before the scheduled time may incur a fee.",
  },
  {
    q: "How is pricing calculated?",
    a: "Based on item type, size, distance, and service level. You always see the final price before confirming.",
  },
  {
    q: "Is my payment secure?",
    a: "Yes. All payments go through Stripe — PCI-DSS Level 1 certified, the highest certification in the payments industry.",
  },
];
  ...
  const channels = [
    {
      icon: Mail,
      title: "Email",
      desc: "support@bulky.app",
      href: "mailto:support@bulky.app",
            ...
            <div key={i}>
              ...
              >
                ...
                >
                  <ChevronRight
                    size={16}
                    className="text-gray-300 shrink-0 ml-4"
                  />
                </motion.div>
              </button>
              <motion.div
              ...
              >
                <p className="px-6 pb-4 pl-14 text-sm text-text-light font-medium leading-relaxed">
                  {faq.a}
                </p>
              </motion.div>
            </div>
