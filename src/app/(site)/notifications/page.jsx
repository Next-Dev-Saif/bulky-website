        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-text-light mt-1 font-medium">
              {unreadCount > 0
                ? <><span className="text-primary font-bold">{unreadCount} unread</span> — tap a notification to dismiss</>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden divide-y divide-gray-50">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
              ...
              <h3 className="text-base font-bold text-secondary mb-1">All caught up!</h3>
