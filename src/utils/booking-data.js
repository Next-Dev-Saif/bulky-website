...
export const ServiceTiers = [
  {
    ...
    description: "Standard curbside pickup and delivery.",
  },
  {
    label: "Ground Floor Delivery with Unboxing",
    value: "Ground Floor Delivery with Unboxing",
    description: "Item brought inside and unboxed for you.",
  },
  {
    label: "White Glove Service",
    value: "White Glove Service",
    description: "Full room-of-choice setup and debris removal.",
  },
];
